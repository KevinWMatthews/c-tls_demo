...
#define CLIENT_CERT     "../tls_demo/ssl2/intermediate_ca/tls_demo_dev_2_client.crt.pem"
#define CLIENT_KEY      "../tls_demo/ssl2/intermediate_ca/tls_demo_dev_2_client.key.pem"
